            ...
            <Col lg={12} md={12}>
                <div className={cx('line-bottom')}>
                    ...
                    <div className={cx('code-block')}>
                        <b className={cx('code')}>Mã lớp: {data.idClass}</b>
                        <FaAngleDoubleRight
                ...
                <Row>
                    ...
                    <Col lg={4} className={cx('request-block')}>
                        ...
                        <span><b>Yêu cầu gia sư:</b> {data.tutorGender}({data.degree})</span>
                    </Col>
                    <Col lg={4} className={cx('request-block')}>
                        <AiOutlineSchedule className={cx('icon-request')}/>
                        <span>Tuần học <b>2</b> buổi (90 phút/buổi)</span>
                    </Col>
                </Row>
                <Row>
