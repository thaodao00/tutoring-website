...
function Register() {
    ...
    return (
        <div className={cx('container')}>
                        ...
                        <div>
                            ...
                            <div className={cx('error')}>
                                <error className={cx('text-error')}>
                                    ...
                                    {errors.confirmPassword?.type === 'minLength' && 'Mật khẩu không nhỏ hơn 3 ký tự'}
                                    {errors.confirmPassword?.type === 'maxLength' && 'Mật khẩu không lớn hơn 20 ký tự'}
                                </error>
                            </div>
            ...
            {/* <LoadingOverlay active={auth.loading} spinner text="Loading your content..."> */}
